              ...
              <tr>
                ...
                <?php
                  if ($this->session->userdata('role') == 'admin') {
                    echo '<th rowspan="2" class="text-center"><i class="fas fa-cog"></i></th>';
                  }
                ?>
              </tr>
              <tr>
            ...
            <tbody>
              <?php
                ...
                foreach ($dosen as $value) {
                  ...
                  $jumlah1 = jumlah($value['id'],$kuotaProses,'id_dosen_1'); // jumlah bimbingan 1
                  $jumlah2 = jumlah($value['id'],$kuotaProses2,'id_dosen_2'); // jumlah bimbinga 2
                  echo '<td>'.$jumlah1.'</td>';
                  echo '<td>'.$jumlah2.'</td>';
                  // echo '<td>'.$selesai.'</td>';
                  // echo '<td>'.$selesai2.'</td>';
                  ...
                  if ($this->session->userdata('role') == 'admin') {
                    echo '<td><a title="Detail" href="'.base_url().'admin/kuota/detail/'.$value['id'].'" class="btn btn-info"><i class="far fa-file-alt"></a></td>';
                  }
                  echo '</tr>';
                  $no++;
                }
