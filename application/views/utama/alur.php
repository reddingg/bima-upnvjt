			...
			<ul class="timeline">
		        <?php
                    ...
                    foreach ($data as $value) {
                        if ($no % 2 != 0) { $class = 'timeline-inverted'; }
                        else { $class = ''; }

                        echo '<li class="'.$class.'">
                              <div class="timeline-badge"><i class="'.$value['icon'].'"></i></i></div>
                              <div class="timeline-panel">
                                <div class="timeline-heading">
                                  <h3 class="timeline-title">'.$value['judul'].'</h3>
                                </div>
                                <div class="timeline-body">';
                        if ($value['keterangan'] != '') {
                            echo '<p style="margin:0;"'.$value['keterangan'].'</p>';
                        }
                        echo    '</div>
                              </div>
                            </li>';
